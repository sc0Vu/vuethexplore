...
var canPromise = __webpack_require__("cJP9")
...
// module
exports.push([module.i, ".loading .button[data-v-2bfb808a]{border:none}.loading .button[data-v-2bfb808a]:hover{cursor:auto}", "", {"version":3,"sources":["/Users/chenqiguan/Desktop/opensource/vuethexplore/src/views/Address.vue"],"names":[],"mappings":"AACA,kCACE,WAAa,CACd,AACD,wCACE,WAAgB,CACjB","file":"Address.vue","sourcesContent":["\n.loading .button[data-v-2bfb808a] {\n  border: none;\n}\n.loading .button[data-v-2bfb808a]:hover {\n  cursor: initial;\n}\n"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_qrcode__ = __webpack_require__("71e1");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["d" /* mapState */])({
    ...
    isContractAddress: function isContractAddress() {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      __WEBPACK_IMPORTED_MODULE_2_qrcode___default.a.toDataURL(_this.address).then(function (dataURI) {
        _this.addressQRCodeURI = dataURI;
        _this.notify({ text: 'Render qrcode successfully!', class: 'is-info' });
      }).catch(function (err) {
        _this.notify({ text: 'Failed to render qrcode! Error: ' + err.message, class: 'is-danger' });
      });
    });
  },
  ...
  methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapActions */])(['notify', 'setLoading']), {
    ...
    getAddressBalance: function getAddressBalance(address) {
      var _this3 = this;

      return this.web3.eth.getBalance.request(address, function (err, balance) {
        if (err) {
          _this3.notify({ text: 'Failed to get balance ' + address + '! Error: ' + err.message, class: 'is-danger' });
          return;
        }
        _this3.balance = balance;
      });
    },
    getAddressCode: function getAddressCode(address) {
      var _this4 = this;

      return this.web3.eth.getCode.request(address, function (err, code) {
        _this4.$nextTick(function () {
          _this4.setLoading(false);
        });

        if (err) {
          _this4.notify({ text: 'Failed to get code ' + address + '! Error: ' + err.message, class: 'is-danger' });
          return;
        }
        _this4.code = code;
      });
...
//# sourceMappingURL=0.be49343a2b37ca4989e1.js.map